...
:math:`\theta` with :math:`\theta^n = 1`, is written as an abstract
:class:`~mathematicskit.abstract_algebra.core.base.FiniteGroup` whose
elements are just the strings ``"1", "θ", "θ²", ...``. Its Cayley table
is identical to that of :math:`\mathbb{Z}_6`, while the non-abelian
:math:`S_3` of the same order gives a visibly different, non-symmetric
table.
"""
