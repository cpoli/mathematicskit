"""Abstract base classes and result containers for mathkit.probability.
...
:mod:`mathkit.probability.systems.discrete` and
:mod:`mathkit.probability.systems.continuous` -- mirroring
:mod:`mathkit.numerical_analysis.core.base.Interpolant`'s pattern of a
...
:mod:`mathkit.probability.systems.monte_carlo`.
"""
