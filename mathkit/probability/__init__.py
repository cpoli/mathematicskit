"""mathkit.probability: probability theory, built directly on scipy.stats.

Discrete and continuous distribution classes (binomial, Poisson,
geometric, uniform, exponential, normal, gamma) wrapping
``scipy.stats``, with mathkit's own moment generating function added on
...
from mathkit.probability.core.base import ContinuousDistribution, DiscreteDistribution, MonteCarloResult
...
from mathkit.probability.utils.diagnostics import effective_sample_size
