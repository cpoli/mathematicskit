...
:mod:`mathkit.linalg`) to locate fixed points numerically.
...
from mathkit.ode_dynamics.core.base import FixedPointResult
...
def find_fixed_point_newton(f: Callable[[np.ndarray], np.ndarray], x0: np.ndarray, tol: float = 1e-10, max_iter: int = 100):
    ...
    each step done via :func:`mathkit.linalg.systems.lu.lu_solve_system`
