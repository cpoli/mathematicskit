"""Plotting helpers for mathkit.ode_dynamics: phase portraits, bifurcation
...
def plot_vector_field(X, Y, U, V, ax=None):
    ...
    ----------
    X, Y, U, V : ndarray
        From :func:`mathkit.ode_dynamics.systems.phase_portrait.vector_field_grid`.
    ax : matplotlib.axes.Axes, optional
        Axes to draw on; a new figure is created if omitted.
...
def plot_bifurcation_diagram(r_plot, x_plot, ax=None):
    ...
    r_plot, x_plot : ndarray
        From :func:`mathkit.ode_dynamics.systems.logistic_map.bifurcation_diagram`.
    ax : matplotlib.axes.Axes, optional
        Axes to draw on; a new figure is created if omitted.
...
def plot_poincare_points(xs, ys, ax=None):
    ...
    ----------
    xs, ys : ndarray
        From :func:`mathkit.ode_dynamics.systems.poincare.stroboscopic_poincare_section`.
    ax : matplotlib.axes.Axes, optional
        Axes to draw on; a new figure is created if omitted.
