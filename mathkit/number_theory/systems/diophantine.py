...
from mathkit.number_theory.core.base import LinearDiophantineResult, PellResult
...
def solve_linear_diophantine(a: int, b: int, c: int) -> LinearDiophantineResult:
    ...
    solution :math:`(x_0, y_0)` (scaled up from :func:`~mathkit.number_theory.systems.modular_arithmetic.extended_gcd`'s
...
def solve_pell_equation(d: int) -> PellResult:
    ...
    :func:`~mathkit.number_theory.systems.continued_fractions.continued_fraction_expansion`
