"""mathkit.abstract_algebra: group, ring, and field theory made computational.
...
from mathkit.abstract_algebra.core.base import FiniteGroup, GroupPropertiesResult, Polynomial
