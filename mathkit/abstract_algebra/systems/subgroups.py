...
def cyclic_subgroup(group: FiniteGroup, generator) -> list:
    ...
    Its size equals :meth:`~mathkit.abstract_algebra.core.base.FiniteGroup.element_order`\
...
def all_subgroups(group: FiniteGroup) -> list:
    ...
    <mathkit.abstract_algebra.core.base.FiniteGroup.elements>` (closing
...
def left_cosets(group: FiniteGroup, subgroup: list) -> list:
    ...
    <mathkit.abstract_algebra.core.base.FiniteGroup.elements>` into
