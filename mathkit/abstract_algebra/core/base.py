...
polynomial class, shared across mathkit.abstract_algebra's systems/
modules.
...
class FiniteGroup(ABC):
    ...
    Concrete subclasses (:class:`~mathkit.abstract_algebra.systems.groups.CyclicGroup`,
    :class:`~mathkit.abstract_algebra.systems.groups.PermutationGroup`)
