"""Plotting helpers for mathkit.calculus: quadrature convergence and
...
from mathkit.calculus.utils.series_utils import partial_sums
...
def plot_taylor_series_convergence(coefficients: np.ndarray, x: float, exact: float, ax=None, label=None):
    ...
    coefficients : ndarray
        From :func:`mathkit.calculus.systems.taylor_series.maclaurin_coefficients`.
    x : float
    exact : float
