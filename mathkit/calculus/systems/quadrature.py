...
rules. mathkit's value-add is the shared :class:`~mathkit.calculus.core.base.Quadrature`
interface and :class:`~mathkit.calculus.core.base.QuadratureResult`
...
from mathkit.calculus.core.base import Quadrature, QuadratureResult
