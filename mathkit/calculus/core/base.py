"""Abstract base classes and result containers for mathkit.calculus.

:class:`Quadrature` is the shared interface for the numerical-integration
rules in :mod:`mathkit.calculus.systems.quadrature` (mirroring
:mod:`mathkit.numerical_analysis.core.base.IterativeRootFinder`'s pattern
of one ABC per algorithmic family, paired with a stable dataclass
result). Differentiation (:mod:`mathkit.calculus.systems.finite_differences`)
and the two automatic-differentiation engines
(:mod:`mathkit.calculus.systems.dual_numbers`,
:mod:`mathkit.calculus.systems.autodiff`) are simple enough (a handful of
