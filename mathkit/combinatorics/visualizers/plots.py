"""Plotting helpers for mathkit.combinatorics: Pascal's triangle, Young
...
def plot_pascals_triangle(triangle, ax=None):
    ...
    triangle : list of list of int
        From :func:`~mathkit.combinatorics.systems.pascals_triangle.pascals_triangle`.
...
def plot_partition_counts(max_n: int, ax=None):
    ...
    matplotlib.axes.Axes
    """
    from mathkit.combinatorics.systems.partitions import partition_function
