...
iterate-path-exposing methods in :mod:`mathkit.optimization.systems`
(gradient descent, nonlinear conjugate gradient, and the scipy-backed
Newton/BFGS wrappers), mirroring
:mod:`mathkit.numerical_analysis.core.base.IterativeRootFinder`'s
...
:mod:`mathkit.optimization.systems.constrained`;
:class:`LinearProgramResult` wraps
:func:`~mathkit.optimization.systems.linear_programming.linear_program`.
"""
...
class OptimizeResult:
    ...
    plots (see :mod:`mathkit.optimization.visualizers.plots`)."""
    ...
    schedule for :class:`~mathkit.optimization.systems.constrained.PenaltyMethod`)."""
...
class LinearProgramResult:
    """Container for the output of :func:`~mathkit.optimization.systems.linear_programming.linear_program`."""
