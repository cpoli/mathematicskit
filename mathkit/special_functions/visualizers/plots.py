"""Plotting helpers for mathkit.special_functions: orthogonal polynomial
...
def plot_polynomial_family(poly_func, degrees, x_range=(-1.0, 1.0), ax=None):
    ...
    poly_func : callable
        ...
        :func:`~mathkit.special_functions.systems.orthogonal_polynomials.legendre_polynomial`).
...
def plot_fft_timing_comparison(sizes, ax=None, seed: int = 0):
    ...
    matplotlib.axes.Axes
    """
    from mathkit.special_functions.systems.fourier_transform import compare_fft_methods
