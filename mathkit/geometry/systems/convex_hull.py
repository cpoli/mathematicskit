...
correctly in any dimension; mathkit does not reimplement it as the
...
from mathkit.geometry.core.base import ConvexHullResult
...
def graham_scan(points: np.ndarray) -> ConvexHullResult:
    ...
    *Computational Geometry*, 3rd ed., Ch. 1.1.
    ...
    from mathkit.geometry.systems.polygon import polygon_area
