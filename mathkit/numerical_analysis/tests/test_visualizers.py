"""Smoke tests for mathkit.numerical_analysis.visualizers: right return
type, no exceptions."""
...
from mathkit.numerical_analysis.systems.chebyshev import chebyshev_nodes, runge_phenomenon_errors
from mathkit.numerical_analysis.systems.root_finding import Bisection
from mathkit.numerical_analysis.systems.splines import CubicSpline
from mathkit.numerical_analysis.visualizers.plots import plot_convergence_history, plot_interpolant, plot_runge_phenomenon
