...
(see :func:`mathkit.numerical_analysis.utils.error_analysis.lebesgue_constant`)
...
def runge_phenomenon_errors(degrees, n_eval: int = 1000):
    ...
    True
    """
    from mathkit.numerical_analysis.systems.interpolation import LagrangeInterpolant
