...
mathkit's value-add is the shared :class:`~mathkit.numerical_analysis.core.base.Interpolant`
interface (matching :class:`~mathkit.numerical_analysis.systems.interpolation.LagrangeInterpolant`
