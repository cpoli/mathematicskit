"""Abstract base classes and result containers for mathkit.fractals_chaos.
...
:mod:`mathkit.fractals_chaos.systems.ifs`; :class:`CellularAutomaton`
is the shared interface for the 1D/2D cellular automata in
:mod:`mathkit.fractals_chaos.systems.cellular_automata`. Both mirror
