...
from mathkit.fractals_chaos.core.base import EscapeTimeResult
...
def mandelbrot_set(extent=(-2.0, 1.0, -1.5, 1.5), resolution: int = 400, max_iter: int = 100) -> EscapeTimeResult:
    ...
    >>> from mathkit.fractals_chaos.systems.mandelbrot_julia import _escape_time_mandelbrot
    >>> import numpy as np
...
def julia_set(c: complex, extent=(-2.0, 2.0, -2.0, 2.0), resolution: int = 400, max_iter: int = 100) -> EscapeTimeResult:
    ...
    >>> from mathkit.fractals_chaos.systems.mandelbrot_julia import _escape_time_julia
    >>> import numpy as np
