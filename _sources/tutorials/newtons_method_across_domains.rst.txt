...
mathkit: as a scalar *root finder* in
:mod:`mathkit.numerical_analysis`, and as a multivariate *optimizer* in
:mod:`mathkit.optimization`. They are, underneath, exactly the same
...
:class:`~mathkit.numerical_analysis.systems.root_finding.NewtonRaphson`
...
.. code-block:: python
   ...
   import numpy as np
   from mathkit.numerical_analysis import NewtonRaphson
...
the quadratic convergence :func:`~mathkit.numerical_analysis.utils.error_analysis.estimate_convergence_order`
...
.. code-block:: python
   ...
   from mathkit.optimization import NewtonMethod, quadratic_bowl, quadratic_bowl_grad, quadratic_bowl_hess
...
Every method in :mod:`mathkit.optimization` that records a per-iterate
path -- :class:`~mathkit.optimization.systems.gradient_descent.GradientDescent`,
:class:`~mathkit.optimization.systems.conjugate_gradient.NonlinearConjugateGradient`,
:class:`~mathkit.optimization.systems.newton_quasi_newton.BFGS` -- can be
compared on exactly the same convergence-order footing that
:mod:`mathkit.numerical_analysis` uses for its own root finders, via
:func:`mathkit.optimization.utils.comparison.function_value_gap`. The
