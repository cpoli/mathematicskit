...
mathematicskit.abstract_algebra's systems/ modules, not a model in its own right.
"""
...
def is_cyclic(group: FiniteGroup) -> bool:
    ...
    :math:`|G|` (via :meth:`~mathematicskit.abstract_algebra.core.base.FiniteGroup.element_order`).
