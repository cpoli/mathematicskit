"""Plotting helpers for mathematicskit.number_theory: prime distribution and
...
def plot_convergent_errors(result, x: float, ax=None):
    ...
    result : ContinuedFractionResult
        From :func:`~mathematicskit.number_theory.systems.continued_fractions.continued_fraction_expansion`.
    x : float
