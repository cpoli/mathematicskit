...
family's three-term recurrence; mathematicskit does not reimplement them. See
...
def chebyshev_polynomial(n: int, x):
    ...
    Chebyshev *nodes* (see :mod:`mathematicskit.numerical_analysis.systems.chebyshev`)
