"""Plotting helpers for mathematicskit.statistics: boxplots, regression
...
def plot_regression_fit(x: np.ndarray, y: np.ndarray, result, ax=None):
    ...
    (:func:`~mathematicskit.statistics.systems.regression.linear_regression`
    with a 1D ``x``).
    ...
    result : RegressionResult
        From :func:`~mathematicskit.statistics.systems.regression.linear_regression`
