...
mathematicskit already has one general-purpose root finder available via
scipy). KKT verification at a candidate point is mathematicskit's own code,
...
from mathematicskit.optimization.core.base import KKTResult, LagrangeResult, OptimizeResult, UnconstrainedOptimizer
...
class PenaltyMethod:
    ...
    :class:`~mathematicskit.optimization.systems.newton_quasi_newton.BFGS` by
