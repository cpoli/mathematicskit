...
#: ``leapfrog_step``/``leapfrog_integrate`` under the name used by the
#: molecular-dynamics/celestial-mechanics literature for this same
#: kick-drift-kick scheme ("velocity Verlet").
...
def yoshida4_step(
    ...
    remains symplectic, it -- like leapfrog -- conserves invariants far
    better than RK4 over long integrations, now with much smaller local
