...
mathematicskit.numerical_analysis's root-finding, interpolation, and regression
systems.
"""
...
def condition_number(matrix: np.ndarray) -> float:
    ...
    :func:`~mathematicskit.numerical_analysis.systems.regression.PolynomialRegression`'s
