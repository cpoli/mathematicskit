"""Mathematical constants and shared numerical tolerances used across mathematicskit.
...
converge" means the same thing everywhere in mathematicskit instead of each
